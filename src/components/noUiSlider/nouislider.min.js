    ...
    function j(t, f, o) {
                    ...
                    r = (function (e, t, r) {
                        ...
                        if (n) {
                            var l = function (t) {
                                t = t.target;
                                return (
                                    t === r || r.contains(t) || (e.composed && e.composedPath().shift() === r)
                                );
                            };
        ...
        function Y(t) {
            ...
            Object.keys(b).forEach(function (t) {
                ...
                (n && n !== e) ||
                    (i && i !== r) ||
                    ((((e = r) !== mt.aria && e !== mt.tooltips) || i === r) && delete b[t]);
            });
        }
        function I(r, n, i) {
            Object.keys(b).forEach(function (t) {
        ...
        function W(t, e, r, n, i, o, s) {
            ...
            return (
                1 < l.length &&
                    ...
                    (n &&
                        0 < e &&
                        ((a = S.getAbsoluteDistance(t[e - 1], f.margin, !1)), (r = Math.max(r, a))),
                    i &&
                        e < l.length - 1 &&
                        ((a = S.getAbsoluteDistance(t[e + 1], f.margin, !0)), (r = Math.min(r, a)))),
                1 < l.length &&
                    f.limit &&
                    (n && 0 < e && ((a = S.getAbsoluteDistance(t[e - 1], f.limit, !1)), (r = Math.min(r, a))),
                    i &&
                        e < l.length - 1 &&
                        ((a = S.getAbsoluteDistance(t[e + 1], f.limit, !0)), (r = Math.max(r, a)))),
                f.padding &&
                    (0 === e && ((a = S.getAbsoluteDistance(0, f.padding[0], !1)), (r = Math.max(r, a))),
                    e === l.length - 1 &&
                        ((a = S.getAbsoluteDistance(100, f.padding[1], !0)), (r = Math.min(r, a)))),
