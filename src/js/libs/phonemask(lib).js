    ...
    (function (e) {
        ...
        (f.prototype = {
            ...
            getElementsRealValue: function () {
                for (
                    var e = this.$form.querySelectorAll('*'), t = void 0, i = {}, r = 0, n = e.length;
                    r < n;
                    ++r
                )
                ...
                if (p)
                    for (var g in p) {
                        ...
                        switch (g) {
                            ...
                            case u:
                                if (!y || 'object' !== ('undefined' == typeof y ? 'undefined' : _typeof(y)))
                                    break;
            ...
            clearErrors: function () {
                for (
                    var e = document.querySelectorAll('.js-validate-error-label'), t = 0, i = e.length;
                    t < i;
                    ++t
                )
                    e[t].remove();
                        ...
                        if (regexMask)
                            ...
                            '.' === element
                                ? mtoken.matches.splice(position++, 0, {
                                      ...
                                      optionality: !1,
                                      newBlockMarker:
                                          void 0 === prevMatch ? 'master' : prevMatch.def !== element,
                                      casing: null,
                                      def: element,
                                      placeholder: void 0,
                                      nativeDef: element
                                  ...
                                  $.each(element.split(''), function (ndx, lmnt) {
                                      (prevMatch = mtoken.matches[position - 1]),
                                          mtoken.matches.splice(position++, 0, {
                                              ...
                                              placeholder:
                                                  void 0 !== opts.staticDefinitionSymbol ? lmnt : void 0,
            ...
            function (module, exports, __webpack_require__) {
                ...
                Inputmask.extendAliases({
                    ...
                    email: {
                        ...
                        onBeforePaste: function onBeforePaste(pastedValue, opts) {
                            return (
                                (pastedValue = pastedValue.toLowerCase()), pastedValue.replace('mailto:', '')
                            );
                        },
                        definitions: {
                            '*': {
                            ...
                            function handleMatch(match, loopNdx, quantifierRecurse) {
                                ...
                                if (void 0 !== match.matches) {
                                    if (match.isGroup && quantifierRecurse !== match) {
                                        ...
                                        for (
                                            var qt = match,
                                                qndx = 0 < ndxInitializer.length ? ndxInitializer.shift() : 0;
                                            qndx <
                        ...
                        if (
                            ...
                            for (
                                ...
                                if (
                                    ...
                                    (end <= i ||
                                        (begin <= i &&
                                            IsEnclosedStatic(i, positionsClone, { begin: begin, end: end })))
                                ) {
                                    for (; '' !== getTest(posMatch).match.def; ) {
                                        if (
                                            !1 !==
                                                (canMatch = positionCanMatchDefinition(posMatch, t, opts)) ||
                                            '+' === t.match.def
                                        ) {
                            ...
                            keypressEvent: function keypressEvent(e, checkval, writeOut, strict, ndx) {
                                ...
                                if (k) {
                                    ...
                                    if ((e.preventDefault(), checkval))
                                        return (
                                            !1 !== valResult && (valResult.forwardPosition = forwardPosition),
                                            valResult
                                        );
                                }
                            },
                            ...
                            inputFallBackEvent: function inputFallBackEvent(e) {
                                ...
                                function analyseChanges(inputValue, buffer, caretPos) {
                                    ...
                                    for (i = 0, bl = newBuffer.length; i < bl; i++)
                                        switch (
                                            ((placeholder = getPlaceholder(translatePosition(i))), action)
                                        ) {
                                            case 'insertText':
            ...
            function (module, exports, __webpack_require__) {
                        ...
                        if (((tstNdx = parseInt(tstNdx)), posNdx <= tstNdx))
                            for (var ndx = 0, ndxl = maskset.tests[tstNdx].length; ndx < ndxl; ndx++)
                                if (
                                    ...
                                    return (
                                        tstNdx +
                                        (void 0 !== maskset.validPositions[tstNdx] && '-' !== symbol ? 1 : 0)
                                    );
                    return posNdx;
                }
                ...
                Inputmask.extendAliases({
                    numeric: {
                        ...
                        onBeforeMask: function onBeforeMask(initialValue, opts) {
                            ...
                            var valueParts = initialValue.split(radixPoint),
                                ...
                                decimalPart =
                                    1 < valueParts.length ? valueParts[1].replace(/[^0-9]/g, '') : '',
                        ...
                        onKeyDown: function onKeyDown(e, buffer, caretPos, opts) {
                            ...
                            if (
                                ...
                                if (
                                    buffer[
                                        e.keyCode === keyCode.DELETE ? caretPos.begin - 1 : caretPos.end
                                    ] === opts.negationSymbol.front
                                )
                                    return (
                    ...
                    indianns: {
                        ...
                        _mask: function _mask(opts) {
                            return (
                                '(' + opts.groupSeparator + '99){*|1}(' + opts.groupSeparator + '999){1|1}'
                            );
                        },
                        groupSeparator: ',',
                        radixPoint: '.',
